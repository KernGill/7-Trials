...
export const MOVE_TEMPLATES = {
  ...
  bone_shards: {
    ...
    critChance: 5,
    energyCost: 2,
    // Character-turn cooldowns tick once immediately on the same turn
  ...
  thiefs_prophecy: {
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // Read directly by ExploreState.advanceQTE().
    qteDoubleAdvance: true,
  },
  thiefs_future: {
    id: 'thiefs_future',
    name: "Thief's Future",
    description: 'Every locked door, chest, and temporal chest on the current floor is marked on the map, even before you\'ve explored near it.',
    properties: [MOVE_PROPERTIES.PASSIVE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // Read directly by Minimap.hasEventRevealPassive().
    revealsUnexploredEvents: true,
  },
  thiefs_curiosity: {
    id: 'thiefs_curiosity',
    name: "Thief's Curiosity",
    description: 'Failing a quick-time event grants one immediate retry. Failing that retry too deals 100 damage.',
    properties: [MOVE_PROPERTIES.PASSIVE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // Read directly by ExploreState.finishQTE().
    qteSecondChance: true,
  },
  thiefs_resolve: {
    id: 'thiefs_resolve',
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // qteArrowIncreasePercent read by ExploreState.startQTE(); rewardBonusPercent
  ...
  thiefs_repentance: {
    ...
    name: "Thief's Repentance",
    description: 'Successfully completing any event (locked door, chest, temporal chest) heals 40% of your max health, capped at your max.',
    properties: [MOVE_PROPERTIES.PASSIVE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // Read directly by ExploreState.applyEventSuccessHeal().
    eventSuccessHealPercent: 40,
  },
  thiefs_guilt: {
    id: 'thiefs_guilt',
    name: "Thief's Guilt",
    description: 'The enemy that died last in its party drops materials from 3 independent rolls of its table instead of 1 — more variety, not just triple quantity.',
    properties: [MOVE_PROPERTIES.PASSIVE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    cooldown: 999,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    // Read directly by CombatManager.finishVictory().
    tripleLastKillDrops: true,
  },
  ghosts_thought: {
    id: 'ghosts_thought',
  ...
  vine_trap: {
    id: 'vine_trap',
    name: 'Vine Trap',
    description: 'Arms a trap for 2 turns: if the opponent attacks the user while it\'s active, they get stunned instead of the attack landing.',
    properties: [MOVE_PROPERTIES.DEFENCE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    // and StatusEffectSystem.decayBuffDurations. Fizzles quietly if 2 fight
    // turns pass without ever landing on an attacker.
    attackerStunTrap: { durationFightTurns: 2 },
  },
  flame_guard: {
    id: 'flame_guard',
    name: 'Flame Guard',
  ...
  // ---------------- Vanguard of Darkness (hidden floor-5 boss) ----------------
  ...
  vanguard_frostbite_touch: {
    ...
    description: 'An unavoidable touch that directly inflicts 1 stack of Frostbite.',
  ...
  vanguard_revival: {
    id: 'vanguard_revival',
    name: "Vanguard's Revival",
    description: 'Once per fight, revives at 50% health upon defeat and inflicts 4 stacks of Frostbite on the user.',
    properties: [MOVE_PROPERTIES.PASSIVE],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    trigger: 'on_death',
    selfDebuffs: [{ effect: 'frostbite', stacks: 4 }],
  },
  ...
  umbral_cleave: {
    id: 'umbral_cleave',
    name: 'Umbral Cleave',
    description: 'A heavy two-handed strike that applies 2 stacks of Darkness.',
    properties: [MOVE_PROPERTIES.PHYSICAL, MOVE_PROPERTIES.MELEE, MOVE_PROPERTIES.DEBUFF],
    damage: 24,
    scaling: SCALING_TYPES.STR,
    critChance: 8,
    ...
    cooldown: 4,
    cooldownType: COOLDOWN_TYPES.CHARACTER_TURN,
    debuffs: [{ effect: 'darkness', stacks: 2 }],
  },
  eclipse_malice: {
    id: 'eclipse_malice',
    name: 'Eclipse Malice',
    description: 'Whenever the user takes a melee hit, has a chance to inflict 1 stack of Darkness on the attacker.',
    properties: [MOVE_PROPERTIES.PASSIVE, MOVE_PROPERTIES.DEBUFF],
    damage: 0,
    scaling: SCALING_TYPES.NONE,
    critChance: 0,
    ...
    trigger: 'melee_hit_taken',
    debuffChance: 35,
    debuffs: [{ effect: 'darkness', stacks: 1 }],
  },
};
